...
| **Trả lời** | *Khách hàng Vinmec ngại gọi điện — AI hiểu triệu chứng, gợi ý chuyên khoa & bác sĩ, đặt lịch 24/7.* | *AI gợi ý sai khoa → User có thể mô tả lại triệu chứng hoặc chọn lại khoa. Hệ thống ghi chú đây là "AI-suggested" để lễ tân kiểm tra lại.* | *~$0.02/phiên, latency <3s, risk chính: lệch chuyên khoa khi input quá ngắn/mơ hồ (đã có nhánh hỏi thêm thông tin và guardrails cấp cứu).* |
...
| Low-confidence — AI không chắc | System báo "không chắc" bằng cách nào? User quyết thế nào? | *AI chưa gợi ý bác sĩ ngay mà yêu cầu user bổ sung thông tin (triệu chứng chính, vị trí, thời điểm, mức độ, dấu hiệu kèm theo); đủ dữ kiện mới gợi ý chuyên khoa.* |
...
### Feature: *Transport & Follow-up (XanhSM + Rating)*

**Trigger:** *User đã đặt lịch khám thành công.*

| Path | Câu hỏi thiết kế | Mô tả |
|------|-------------------|-------|
| Happy — chọn XanhSM | User thấy gì? | *User chọn "Đặt xe XanhSM", chọn giờ rảnh và địa chỉ đón; hệ thống xác nhận đặt xe + lịch khám.* |
| Happy — tự di chuyển | User thấy gì? | *User chọn "Tự di chuyển", chọn giờ rảnh; hệ thống xác nhận hoàn tất luồng và hiển thị đánh giá sao.* |
| Failure — thiếu dữ liệu | Recover ra sao? | *Nếu chưa chọn phương tiện/chưa chọn giờ/thiếu địa chỉ khi chọn XanhSM, chatbot báo lỗi rõ ràng và yêu cầu nhập lại.* |
| Guardrail — giờ rảnh không hợp lệ | Hệ thống chặn thế nào? | *Giờ rảnh phải sớm hơn giờ khám đã đặt; nếu không hợp lệ thì UI + backend đều từ chối.* |

### Feature: *Safety Guardrails (Emergency + Out-of-scope)*

**Trigger:** *User nhập triệu chứng nguy kịch hoặc nhập câu hỏi ngoài phạm vi y tế.*

| Path | Câu hỏi thiết kế | Mô tả |
|------|-------------------|-------|
| Emergency | Điều hướng thế nào? | *Phát hiện nguy cơ cấp cứu (keyword + confidence) và hiển thị hotline 115 + Vinmec 1900 2345.* |
| Out-of-scope | Chặn thế nào? | *Nếu user hỏi ngoài phạm vi phân luồng khám bệnh, chatbot từ chối lịch sự và yêu cầu quay lại mô tả triệu chứng sức khỏe.* |
| Clarify | Khi nào hỏi thêm? | *Nếu thông tin chưa đủ, chatbot trả về nhánh clarify trước khi đề xuất chuyên khoa/bác sĩ.* |
| Recovery | Quay lại flow chính ra sao? | *Ngay khi user cung cấp thông tin triệu chứng hợp lệ, hệ thống quay lại luồng triage và booking bình thường.* |
